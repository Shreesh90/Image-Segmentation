...
ax.imshow(x[25], cmap="gray")
plt.title("Original Image")
ax = fig.add_subplot(1,3,2)
ax.imshow(np.reshape(result1[25]*255, (IMAGE_SIZE, IMAGE_SIZE)), cmap="gray")
plt.title("UNet Mask")
ax = fig.add_subplot(1,3,3)
ax.imshow(np.reshape(result2[25]*255, (IMAGE_SIZE, IMAGE_SIZE)), cmap="gray")
